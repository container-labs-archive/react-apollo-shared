...
function queryLoader(WrappedComponent) {
  ...
  return _temp = /*#__PURE__*/function (_Component) {
    _inheritsLoose(HOCQueryLoader, _Component);
    ...
    _proto.render = function render() {
      ...
      var content = /*#__PURE__*/_react["default"].createElement(_Loader["default"], null); // doesn't handle when there are multiple concurrent requests


      if (!loading) {
        if (error) {
          content = /*#__PURE__*/_react["default"].createElement(_GenericError["default"], {
            error: error.message
          });
        } else {
